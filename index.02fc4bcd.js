...
//   ],
// ];
let oa=[[{category:"California Rappers",words:["A","AA","AAA","AAAA"],difficulty:1},{category:"Black Founded Clothing Brands",words:["B","BB","BBB","BBBB"],difficulty:2},{category:"Hair Cut Styles",words:["C","CC","CCC","CCCC"],difficulty:3},{category:"Black Mayors",words:["D","DD","DDD","DDDD"],difficulty:4,imageSrc:"https://i.ibb.co/pP1xn0Z/Connections.png"},{category:"Mystery",words:["Are","You","THere","God"],difficulty:5}]],ol=()=>rI(Date.now()),os=new Date(2023,9,23),ou=e=>{let t=rI(e),n=function(e,t){rM(2,arguments);var n=rD(e),r=rD(t),o=rF(n,r),i=Math.abs(function(e,t){rM(2,arguments);var n=rI(e),r=rI(t);// Round the number of days to the nearest integer
...
if(!o)return new Date(NaN);var i=!!o[4],a=rH(o[1]),l=rH(o[2])-1,s=rH(o[3]),u=rH(o[4]),c=rH(o[5])-1;if(i)return u>=1&&u<=53&&c>=0&&c<=6?((n=new Date(0)).setUTCFullYear(t,0,4),r=n.getUTCDay()||7,n.setUTCDate(n.getUTCDate()+((u-1)*7+c+1-r)),n):new Date(NaN);var d=new Date(0);return l>=0&&l<=11&&s>=1&&s<=(rG[l]||(rq(t)?29:28))&&a>=1&&a<=(rq(t)?366:365)?(d.setUTCFullYear(t,l,Math.max(a,s)),d):new Date(NaN)}(l.restDateString,l.year)}if(!r||isNaN(r.getTime()))return new Date(NaN);var s=r.getTime(),u=0;if(a.time&&isNaN(u=function(e){var t=e.match(rW);if(!t)return NaN;// Invalid ISO-formatted time
...
_start(){let e=this.animation;i6(this).reset(iN(e.to)),e.immediate||(e.fromValues=e.values.map(e=>e.lastPosition)),aU(this)||(aW(this,!0),aV(this)||this._resume())}_resume(){oR.skipAnimation?this.finish():it.start(this)}/**
   ...
   */_stop(e,t){if(aU(this)){aW(this,!1);let n=this.animation;oX(n.values,e=>{e.done=!0}),n.toValues&&(n.onChange=n.onPause=n.onResume=void 0),iO(this,{type:"idle",parent:this});let r=t?aj(this.get()):aN(this.get(),aY(this,e??n.to));o1(this._pendingCalls,r),n.changed&&(n.changed=!1,aZ(this,"onRest",r,this))}}};function aY(e,t){let n=aw(t),r=aw(e.get());return oK(r,n)}function aG(e,t=e.loop,n=e.to){let r=ad(t);if(r){let o=!0!==r&&ab(r),i=(o||e).reverse,a=!o||o.reset;return aq({...e,loop:t,// Avoid updating default props when looping.
...
fillOpacity:1,floodOpacity:1,stopOpacity:1,strokeDasharray:1,strokeDashoffset:1,strokeMiterlimit:1,strokeOpacity:1,strokeWidth:1},uO={},uA=uO={};function uM(){throw Error("setTimeout has not been defined")}function uD(){throw Error("clearTimeout has not been defined")}function uI(e){if(cn===setTimeout)return setTimeout(e,0);// if setTimeout wasn't available but was latter defined
 ...
 * _.isSymbol('abc');
 * // => false
 */function(e){return"symbol"==typeof e||fj(e)&&"[object Symbol]"==fu(e)};/** Used as references for various `Number` constants. */var fO=0/0,fA=/^[-+]0x[0-9a-f]+$/i,fM=/^0b[01]+$/i,fD=/^0o[0-7]+$/i,fI=parseInt;fC=/**
...
var n=(mS(e)+"e").split("e"),r=o(n[0]+"e"+(+n[1]+t));return+((n=(mS(r)+"e").split("e"))[0]+"e"+(+n[1]-t))}return o(e)};var mO={},mA={},mM={},mD={},mI={},mz={};mz=/**
...
a.set(e,t);var c=gw(l(e),l(t),r,o,i,a);return a.delete(e),c;case"[object Symbol]":if(gO)return gO.call(e)==gO.call(t)}return!1};var gA={},gM={},gD={},gI={};gI=/**
 ...
 * @returns {boolean} Returns `true` if the values are equivalent, else `false`.
 */function e(t,n,r,o,i){return t===n||(null!=t&&null!=n&&(fj(t)||fj(n))?mM(t,n,r,o,e,i):t!=t&&n!=n)},mO=/**
...
(0,y.useEffect)(()=>{i&&!m.isClosePausedRef.current&&A(C)},[i,C,m.isClosePausedRef,A]),(0,y.useEffect)(()=>(N(),()=>j()),[N,j]);let M=(0,y.useMemo)(()=>g?function e(t){let n=[],r=Array.from(t.childNodes);// This allows SR VO to naturally pause break between nodes while announcing.
