...
//   ],
// ];
let oa=[[{category:"California Rappers",words:["A","AA","AAA","AAAA"],difficulty:1},{category:"Black Founded Clothing Brands",words:["B","BB","BBB","BBBB"],difficulty:2},{category:"Hair Cut Styles",words:["C","CC","CCC","CCCC"],difficulty:3},{category:"Black Mayors",words:["D","DD","DDD","DDDD"],difficulty:4,imageSrc:"https://i.ibb.co/pP1xn0Z/Connections.png"},{category:"Mystery",words:["Are","You","THere","God"],difficulty:5}]],ol=()=>rL(Date.now()),os=new Date(2023,9,23),ou=e=>{let t=rL(e),n=function(e,t){rD(2,arguments);var n=rI(e),r=rI(t),o=r$(n,r),i=Math.abs(function(e,t){rD(2,arguments);var n=rL(e),r=rL(t);// Round the number of days to the nearest integer
