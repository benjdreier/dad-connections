...
console.warn(Error().stack)),new Date(NaN)))}function rI(e){rD(1,arguments);var t=rz(e);return t.setHours(0,0,0,0),t}/**
...
function rF(e,t){var n=e.getFullYear()-t.getFullYear()||e.getMonth()-t.getMonth()||e.getDate()-t.getDate()||e.getHours()-t.getHours()||e.getMinutes()-t.getMinutes()||e.getSeconds()-t.getSeconds()||e.getMilliseconds()-t.getMilliseconds();return n<0?-1:n>0?1:n}function rL(e){if(null===e||!0===e||!1===e)return NaN;var t=Number(e);return isNaN(t)?t:t<0?Math.ceil(t):Math.floor(t)}function r$(e,t){rD(2,arguments);var n=rz(e),r=rL(t);return isNaN(r)?new Date(NaN):(r&&n.setDate(n.getDate()+r),n)}var rU={dateTimeDelimiter:/[T ]/,timeZoneDelimiter:/[Z ]/i,timezone:/([Z+-].*)$/},rV=/^-?(?:(\d{3})|(\d{2})(?:-?(\d{2}))?|W(\d{2})(?:-?(\d{1}))?|)$/,rW=/^(\d{2}(?:[.,]\d*)?)(?::?(\d{2}(?:[.,]\d*)?))?(?::?(\d{2}(?:[.,]\d*)?))?$/,rB=/^([+-])(\d{2})(?::?(\d{2}))?$/;function rH(e){return e?parseInt(e):1}function rG(e){return e&&parseFloat(e.replace(",","."))||0}// Validation functions
...
//   ],
// ];
const oa=[[{category:"California Rappers",words:["A","AA","AAA","AAAA"],difficulty:1},{category:"Black Founded Clothing Brands",words:["B","BB","BBB","BBBB"],difficulty:2},{category:"Hair Cut Styles",words:["C","CC","CCC","CCCC"],difficulty:3},{category:"Black Mayors",words:["D","DD","DDD","DDDD"],difficulty:4,imageSrc:"https://i.ibb.co/pP1xn0Z/Connections.png"},{category:"Mystery",words:["Are","You","THere","God"],difficulty:5}]],ol=()=>rI(Date.now()),os=new Date(2023,9,23),ou=e=>{let t=rI(e),n=function(e,t){rD(2,arguments);var n=rz(e),r=rz(t),o=rF(n,r),i=Math.abs(function(e,t){rD(2,arguments);var n=rI(e),r=rI(t);// Round the number of days to the nearest integer
 ...
 * lucide-react v0.288.0 - ISC
 */const s0=x("CircleSlash",[["line",{x1:"9",x2:"15",y1:"15",y2:"9",key:"1dfufj"}],["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}]]),s1=x("Circle",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}]]);function s2({isUsed:e}){return/*#__PURE__*/(0,g.jsx)("div",{children:e?/*#__PURE__*/(0,g.jsx)(s0,{className:"h-4 w-4 mt-1 stroke-neutral-400"}):/*#__PURE__*/(0,g.jsx)(s1,{className:"h-4 w-4 mt-1 fill-green-300 stroke-cyan-300"})})}var s3=function(){let{numMistakesUsed:e}=/*@__PURE__*/f(y).useContext(oE),t=eZ(100);return/*#__PURE__*/(0,g.jsxs)("div",{className:"flex flex-row gap-x-4 justify-center",children:[/*#__PURE__*/(0,g.jsx)("p",{className:"text-base",children:"Mistakes Remaining: "}),t.map(t=>/*#__PURE__*/(0,g.jsx)(s2,{isUsed:t<e},t))]})},y=(m("bh6RR"),m("bh6RR"),m("bh6RR"),m("bh6RR")),s4={};//
