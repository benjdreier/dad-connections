...
.filter(function(e){if(!e.isTailwindClass)return!0;var t=e.modifierId,n=e.classGroupId,r=e.hasPostfixModifier,o=t+n;return!s.has(o)&&(s.add(o),l(n,r).forEach(function(e){return s.add(t+e)}),!0)}).reverse().map(function(e){return e.originalClassName}).join(" "));return n(r,c),c}return function(){return a(ek.apply(null,arguments))}}(function(){var e=eS("colors"),t=eS("spacing"),n=eS("blur"),r=eS("brightness"),o=eS("borderColor"),i=eS("borderRadius"),a=eS("borderSpacing"),l=eS("borderWidth"),s=eS("contrast"),u=eS("grayscale"),c=eS("hueRotate"),d=eS("invert"),f=eS("gap"),p=eS("gradientColorStops"),h=eS("gradientColorStopPositions"),m=eS("inset"),g=eS("margin"),v=eS("opacity"),y=eS("padding"),b=eS("saturate"),w=eS("scale"),x=eS("sepia"),k=eS("skew"),S=eS("space"),E=eS("translate"),C=function(){return["auto","contain","none"]},R=function(){return["auto","hidden","clip","visible","scroll"]},_=function(){return["auto",eL,t]},P=function(){return[eL,t]},T=function(){return["",eN]},N=function(){return["auto",eI,eL]},j=function(){return["bottom","center","left","left-bottom","left-top","right","right-bottom","right-top","top"]},O=function(){return["solid","dashed","dotted","double","none"]},A=function(){return["normal","multiply","screen","overlay","darken","lighten","color-dodge","color-burn","hard-light","soft-light","difference","exclusion","hue","saturation","color","luminosity","plus-lighter"]},D=function(){return["start","end","center","between","around","evenly","stretch"]},z=function(){return["","0",eL]},I=function(){return["auto","avoid","all","avoid-page","page","left","right","column"]},M=function(){return[eI,ez]},F=function(){return[eI,eL]};return{cacheSize:500,theme:{colors:[e$],spacing:[eN],blur:["none","",eU,eL],brightness:M(),borderColor:[e],borderRadius:["none","","full",eU,eL],borderSpacing:P(),borderWidth:T(),contrast:M(),grayscale:z(),hueRotate:F(),invert:z(),gap:P(),gradientColorStops:[e],gradientColorStopPositions:[eM,ej],inset:_(),margin:_(),opacity:M(),padding:P(),saturate:M(),scale:M(),sepia:z(),skew:F(),space:P(),translate:P()},classGroups:{// Layout
/**
       * Aspect Ratio
...
//   ],
// ];
const oa=[[{category:"California Rappers",words:["A","AA","AAA","AAAA"],difficulty:1},{category:"Black Founded Clothing Brands",words:["B","BB","BBB","BBBB"],difficulty:2},{category:"Hair Cut Styles",words:["C","CC","CCC","CCCC"],difficulty:3},{category:"Black Mayors",words:["D","DD","DDD","DDDD"],difficulty:4,imageSrc:"https://i.ibb.co/pP1xn0Z/Connections.png"},{category:"Mystery",words:["Are","You","THere","God"],difficulty:5}]],ol=()=>rL(Date.now()),os=new Date(2023,9,23),ou=e=>{let t=rL(e),n=function(e,t){rz(2,arguments);var n=rI(e),r=rI(t),o=r$(n,r),i=Math.abs(function(e,t){rz(2,arguments);var n=rL(e),r=rL(t);// Round the number of days to the nearest integer
...
_start(){let e=this.animation;i6(this).reset(iN(e.to)),e.immediate||(e.fromValues=e.values.map(e=>e.lastPosition)),aU(this)||(aW(this,!0),aV(this)||this._resume())}_resume(){oP.skipAnimation?this.finish():it.start(this)}/**
   ...
   */_stop(e,t){if(aU(this)){aW(this,!1);let n=this.animation;oX(n.values,e=>{e.done=!0}),n.toValues&&(n.onChange=n.onPause=n.onResume=void 0),iO(this,{type:"idle",parent:this});let r=t?aj(this.get()):aN(this.get(),aG(this,e??n.to));o1(this._pendingCalls,r),n.changed&&(n.changed=!1,aZ(this,"onRest",r,this))}}};function aG(e,t){let n=aw(t),r=aw(e.get());return oY(r,n)}function aq(e,t=e.loop,n=e.to){let r=ad(t);if(r){let o=!0!==r&&ab(r),i=(o||e).reverse,a=!o||o.reset;return aQ({...e,loop:t,// Avoid updating default props when looping.
...
_detach(){oX(oJ(this.source),e=>{iT(e)&&iI(e,this)}),this._active.clear(),li(this)}/** @internal */eventObserved(e){"change"==e.type?e.idle?this.advance():(this._active.add(e.parent),this._start()):"idle"==e.type?this._active.delete(e.parent):"priority"==e.type&&(this.priority=oJ(this.source).reduce((e,t)=>Math.max(e,(aI(t)?t.priority:0)+1),0))}};function lr(e){return!1!==e.idle}function lo(e){return!e.size||Array.from(e).every(lr)}function li(e){e.idle||(e.idle=!0,oX(i9(e),e=>{e.done=!0}),iO(e,{type:"idle",parent:e}))}oP.assign({createStringInterpolator:iG,to:(e,t)=>new ln(e,t)}),it.advance;// src/applyAnimatedValues.ts
...
var hA="",hD="",hz="",hI="",hM=f5&&"ontouchstart"in document.documentElement;if(f5){// Order matters. We need to check Webkit the last one because
...
gb.prototype.clear=mH,gb.prototype.delete=mG,gb.prototype.get=mq,gb.prototype.has=mQ,gb.prototype.set=mK,mz=gb;var gw={},gx={},gk={};gk=/**
 ...
 */function(e,t,n){var r=t(e);return mR(e)?r:gI(r,n(e))};var gM={},gF={};gF=/**
 ...
 * @param {Object} [stack] Tracks traversed `object` and `other` objects.
 * @returns {boolean} Returns `true` if the objects are equivalent, else `false`.
 */function(e,t,n,r,o,i){var a=mR(e),l=mR(t),s=a?vv:ve(e),u=l?vv:ve(t);s=s==vg?vy:s,u=u==vg?vy:u;var c=s==vy,d=u==vy,f=s==u;if(f&&gY(e)){if(!gY(t))return!1;a=!0,c=!1}if(f&&!c)return i||(i=new mz),a||gX(e)?gw(e,t,n,r,o,i):g_(e,t,s,n,r,o,i);if(!(1&n)){var p=c&&vb.call(e,"__wrapped__"),h=d&&vb.call(t,"__wrapped__");if(p||h){var m=p?e.value():e,g=h?t.value():t;return i||(i=new mz),o(m,g,n,r,i)}}return!!f&&(i||(i=new mz),gA(e,t,n,r,o,i))},mA=/**
