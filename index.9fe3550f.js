...
_detach(){oX(oJ(this.source),e=>{iT(e)&&iz(e,this)}),this._active.clear(),li(this)}/** @internal */eventObserved(e){"change"==e.type?e.idle?this.advance():(this._active.add(e.parent),this._start()):"idle"==e.type?this._active.delete(e.parent):"priority"==e.type&&(this.priority=oJ(this.source).reduce((e,t)=>Math.max(e,(az(t)?t.priority:0)+1),0))}};function lr(e){return!1!==e.idle}function lo(e){return!e.size||Array.from(e).every(lr)}function li(e){e.idle||(e.idle=!0,oX(i9(e),e=>{e.done=!0}),iO(e,{type:"idle",parent:e}))}oP.assign({createStringInterpolator:iq,to:(e,t)=>new ln(e,t)}),it.advance;// src/applyAnimatedValues.ts
...
getComponentProps:({scrollTop:e,scrollLeft:t,...n})=>n}).animated,y=(m("bh6RR"),m("bh6RR"),m("bh6RR"));const lb=["top","right","bottom","left"],lw=Math.min,lx=Math.max,lk=Math.round,lS=Math.floor,lE=e=>({x:e,y:e}),lC={left:"right",right:"left",bottom:"top",top:"bottom"},lR={start:"end",end:"start"};function l_(e,t){return"function"==typeof e?e(t):e}function lP(e){return e.split("-")[0]}function lT(e){return e.split("-")[1]}function lN(e){return"x"===e?"y":"x"}function lj(e){return"y"===e?"height":"width"}function lO(e){return["top","bottom"].includes(lP(e))?"y":"x"}function lA(e){return e.replace(/start|end/g,e=>lR[e])}function lD(e){return e.replace(/left|right|bottom|top/g,e=>lC[e])}function lI(e){return"number"!=typeof e?{top:0,right:0,bottom:0,left:0,...e}:{top:e,right:e,bottom:e,left:e}}function lz(e){return{...e,top:e.y,left:e.x,right:e.x+e.width,bottom:e.y+e.height}}function lM(e,t,n){let r,{reference:o,floating:i}=e,a=lO(t),l=lN(lO(t)),s=lj(l),u=lP(t),c="y"===a,d=o.x+o.width/2-i.width/2,f=o.y+o.height/2-i.height/2,p=o[s]/2-i[s]/2;switch(u){case"top":r={x:d,y:o.y-i.height};break;case"bottom":r={x:d,y:o.y+o.height};break;case"right":r={x:o.x+o.width,y:f};break;case"left":r={x:o.x-i.width,y:f};break;default:r={x:o.x,y:o.y}}switch(lT(t)){case"start":r[l]-=p*(n&&c?-1:1);break;case"end":r[l]+=p*(n&&c?-1:1)}return r}/**
...
function(e,t){let n=se(e,!0,"fixed"===t),r=n.top+e.clientTop,o=n.left+e.clientLeft,i=lK(e)?l8(e):lE(1),a=e.clientWidth*i.x,l=e.clientHeight*i.y,s=o*i.x,u=r*i.y;return{width:a,height:l,x:s,y:u}}(t,n);else{let n=l7(e);r={...t,x:t.x-n.x,y:t.y-n.y}}return lz(r)}function sr(e,t){return lK(e)&&"fixed"!==l1(e).position?t?t(e):e.offsetParent:null}// Gets the closest ancestor positioned element. Handles some edge cases,
...
fillOpacity:1,floodOpacity:1,stopOpacity:1,strokeDasharray:1,strokeDashoffset:1,strokeMiterlimit:1,strokeOpacity:1,strokeWidth:1},uO={},uA=uO={};function uD(){throw Error("setTimeout has not been defined")}function uI(){throw Error("clearTimeout has not been defined")}function uz(e){if(cn===setTimeout)return setTimeout(e,0);// if setTimeout wasn't available but was latter defined
...
`,dE=ds.strong`
  ...
  z-index: 1;
  font-weight: bold;
`;var dC=({color:e=dg,children:t,...n})=>{let[r,o]=/*@__PURE__*/f(y).useState(()=>eZ(3).map(()=>dv(e))),i=dp();return dm(()=>{let t=dv(e),n=Date.now(),i=r.filter(e=>{let t=n-e.createdAt;return t<750});i.push(t),o(i)},i?null:50,i?null:450),/*#__PURE__*/(0,g.jsxs)(dx,{...n,children:[r.map(e=>/*#__PURE__*/(0,g.jsx)(dy,{color:e.color,size:e.size,style:e.style},e.id)),/*#__PURE__*/(0,g.jsx)(dE,{children:t})]})},y=m("bh6RR");let dR=0;const d_=new Map,dP=e=>{if(d_.has(e))return;let t=setTimeout(()=>{d_.delete(e),dO({type:"REMOVE_TOAST",toastId:e})},1e6);d_.set(e,t)},dT=(e,t)=>{switch(t.type){case"ADD_TOAST":return{...e,toasts:[t.toast,...e.toasts].slice(0,1)};case"UPDATE_TOAST":return{...e,toasts:e.toasts.map(e=>e.id===t.toast.id?{...e,...t.toast}:e)};case"DISMISS_TOAST":{let{toastId:n}=t;return n?dP(n):e.toasts.forEach(e=>{dP(e.id)}),{...e,toasts:e.toasts.map(e=>e.id===n||void 0===n?{...e,open:!1}:e)}}case"REMOVE_TOAST":if(void 0===t.toastId)return{...e,toasts:[]};return{...e,toasts:e.toasts.filter(e=>e.id!==t.toastId)}}},dN=[];let dj={toasts:[]};function dO(e){dj=dT(dj,e),dN.forEach(e=>{e(dj)})}function dA({...e}){let t=(dR=(dR+1)%Number.MAX_VALUE).toString(),n=()=>dO({type:"DISMISS_TOAST",toastId:t});return dO({type:"ADD_TOAST",toast:{...e,id:t,open:!0,onOpenChange:e=>{e||n()}}}),{id:t,dismiss:n,update:e=>dO({type:"UPDATE_TOAST",toast:{...e,id:t}})}}function dD(){let[e,t]=y.useState(dj);return y.useEffect(()=>(dN.push(t),()=>{let e=dN.indexOf(t);e>-1&&dN.splice(e,1)}),[e]),{...e,toast:dA,dismiss:e=>dO({type:"DISMISS_TOAST",toastId:e})}}var dI=m("7ORd6");// Share logic from here: https://github.com/cwackerfuss/react-wordle/blob/main/src/lib/share.ts
const dz=["mobile","smarttv","wearable"],dM=new dI.UAParser,dF=dM.getBrowser(),dL=dM.getDevice(),d$=(e,t,n,r,o=!0)=>{let i=window.location.href,a=`Dad Connections #${ov}
 ...
 */function(e){return e?e.slice(0,f_(e)+1).replace(fT,""):e};var fN={},fj={};fj=/**
 ...
 * _.isSymbol('abc');
 * // => false
 */function(e){return"symbol"==typeof e||fj(e)&&"[object Symbol]"==fu(e)};/** Used as references for various `Number` constants. */var fO=0/0,fA=/^[-+]0x[0-9a-f]+$/i,fD=/^0b[01]+$/i,fI=/^0o[0-7]+$/i,fz=parseInt;fC=/**
...
if(!1===(r=pK(n,e.toString({children:!1}),o)))return!1;this.refCssRule(e,o,r)}return this.insertRules(e.rules,r),r}var i=e.toString();if(!i)return!1;var a=pY(n,t),l=pK(n,i,a);return!1!==l&&(this.hasInsertedRules=!0,this.refCssRule(e,a,l),l)},t.refCssRule=function(e,t,n){e.renderable=n,e.options.parent instanceof pI&&this.cssRules.splice(t,0,n)}/**
   ...
   */,t.getRules=function(){return this.element.sheet.cssRules},e}(),pJ=0,p0=/*#__PURE__*/function(){function e(e){this.id=pJ++,this.version="10.10.0",this.plugins=new pz,this.options={id:{minify:!1},createGenerateId:pU,Renderer:f6?pZ:null,plugins:[]},this.generateId=pU({minify:!1});for(var t=0;t<pj.length;t++)this.plugins.use(pj[t],{queue:"internal"});this.setup(e)}/**
...
var hA="",hD="",hI="",hz="",hM=f6&&"ontouchstart"in document.documentElement;if(f6){// Order matters. We need to check Webkit the last one because
...
var n=(mS(e)+"e").split("e"),r=o(n[0]+"e"+(+n[1]+t));return+((n=(mS(r)+"e").split("e"))[0]+"e"+(+n[1]-t))}return o(e)};var mO={},mA={},mD={},mI={},mz={},mM={};mM=/**
 ...
 */function(e){var t=-1,n=Array(e.size);return e.forEach(function(e){n[++t]=e}),n};/** Used to convert symbols to primitives and strings. */var gj=fc?fc.prototype:void 0,gO=gj?gj.valueOf:void 0;g_=/**
...
a.set(e,t);var c=gw(l(e),l(t),r,o,i,a);return a.delete(e),c;case"[object Symbol]":if(gO)return gO.call(e)==gO.call(t)}return!1};var gA={},gD={},gI={},gz={};gz=/**
