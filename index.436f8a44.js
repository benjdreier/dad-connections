 ...
 * Slot
 * -----------------------------------------------------------------------------------------------*/let R=/*#__PURE__*/(0,y.forwardRef)((e,t)=>{let{children:n,...r}=e,o=(0,y.Children).toArray(n),i=o.find(j);if(i){// the new element to render is the one passed as a child of `Slottable`
...
//   ],
// ];
let oa=[[{category:"States Where Dad Lived",words:["New York","Maryland","Massachusetts","Oklahoma"],difficulty:1},{category:"Employers of the members of the Yale board of trustees",words:["Morehouse","Comcast","Connecticut","Yale"],difficulty:2},{category:"Tennis Companions",words:["Cliffe","Guillermo","Mike","Nate"],difficulty:3},{category:"Handsome Men",words:["Dad","Dan","Squidward","Ben"],difficulty:4,imageSrc:"https://preview.redd.it/anybody-else-ironically-think-handsome-squidward-is-really-v0-1snloyd49aob1.jpg?width=1080&crop=smart&auto=webp&s=70fed1d710f73e19982746f5b6394ba440cc81ac"},{category:"Missed Connections",words:["Bruce","Annie","Kennya","Jenny"],difficulty:5},{category:"Al-____ Names",words:["Lie","Ex","F","Bert"],difficulty:6}]],ol=()=>rL(Date.now()),os=new Date(2023,9,23),ou=e=>{let t=rL(e),n=function(e,t){rD(2,arguments);var n=rI(e),r=rI(t),o=r$(n,r),i=Math.abs(function(e,t){rD(2,arguments);var n=rL(e),r=rL(t);// Round the number of days to the nearest integer
...
var aR=(e,t)=>1==t.length?t[0]:t.some(e=>e.cancelled)?aj(e.get()):t.every(e=>e.noop)?aT(e.get()):aN(e.get(),t.every(e=>e.finished)),aT=e=>({value:e,noop:!0,finished:!0,cancelled:!1}),aN=(e,t,n=!1)=>({value:e,finished:t,cancelled:n}),aj=e=>({value:e,cancelled:!0,finished:!1});// src/runAsync.ts
...
_detach(){oX(oJ(this.source),e=>{iT(e)&&iI(e,this)}),this._active.clear(),li(this)}/** @internal */eventObserved(e){"change"==e.type?e.idle?this.advance():(this._active.add(e.parent),this._start()):"idle"==e.type?this._active.delete(e.parent):"priority"==e.type&&(this.priority=oJ(this.source).reduce((e,t)=>Math.max(e,(aI(t)?t.priority:0)+1),0))}};function lr(e){return!1!==e.idle}function lo(e){return!e.size||Array.from(e).every(lr)}function li(e){e.idle||(e.idle=!0,oX(i9(e),e=>{e.done=!0}),iO(e,{type:"idle",parent:e}))}oR.assign({createStringInterpolator:iY,to:(e,t)=>new ln(e,t)}),it.advance;// src/applyAnimatedValues.ts
...
getComponentProps:({scrollTop:e,scrollLeft:t,...n})=>n}).animated,y=(m("exYeM"),m("exYeM"),m("exYeM"));let lb=["top","right","bottom","left"],lw=Math.min,lx=Math.max,lk=Math.round,lS=Math.floor,lE=e=>({x:e,y:e}),lC={left:"right",right:"left",bottom:"top",top:"bottom"},l_={start:"end",end:"start"};function lP(e,t){return"function"==typeof e?e(t):e}function lR(e){return e.split("-")[0]}function lT(e){return e.split("-")[1]}function lN(e){return"x"===e?"y":"x"}function lj(e){return"y"===e?"height":"width"}function lO(e){return["top","bottom"].includes(lR(e))?"y":"x"}function lM(e){return e.replace(/start|end/g,e=>l_[e])}function lA(e){return e.replace(/left|right|bottom|top/g,e=>lC[e])}function lD(e){return"number"!=typeof e?{top:0,right:0,bottom:0,left:0,...e}:{top:e,right:e,bottom:e,left:e}}function lI(e){return{...e,top:e.y,left:e.x,right:e.x+e.width,bottom:e.y+e.height}}function lz(e,t,n){let r,{reference:o,floating:i}=e,a=lO(t),l=lN(lO(t)),s=lj(l),u=lR(t),c="y"===a,d=o.x+o.width/2-i.width/2,f=o.y+o.height/2-i.height/2,p=o[s]/2-i[s]/2;switch(u){case"top":r={x:d,y:o.y-i.height};break;case"bottom":r={x:d,y:o.y+o.height};break;case"right":r={x:o.x+o.width,y:f};break;case"left":r={x:o.x-i.width,y:f};break;default:r={x:o.x,y:o.y}}switch(lT(t)){case"start":r[l]-=p*(n&&c?-1:1);break;case"end":r[l]+=p*(n&&c?-1:1)}return r}/**
 ...
 */function(e){return e?e.slice(0,fP(e)+1).replace(fT,""):e};var fN={},fj={};fj=/**
...
let t=null==g?void 0:g.contains(document.activeElement);t&&(null===(e=m.viewport)||void 0===e||e.focus()),a()}),M=(0,y.useCallback)(e=>{e&&e!==1/0&&(window.clearTimeout(T.current),_.current=new Date().getTime(),T.current=window.setTimeout(O,e))},[O]);(0,y.useEffect)(()=>{let e=m.viewport;if(e){let t=()=>{M(R.current),null==u||u()},n=()=>{let e=new Date().getTime()-_.current;R.current=R.current-e,window.clearTimeout(T.current),null==s||s()};return e.addEventListener(vK,n),e.addEventListener(vX,t),()=>{e.removeEventListener(vK,n),e.removeEventListener(vX,t)}}},[m.viewport,C,s,u,M]),// we include `open` in deps because closed !== unmounted when animating
