...
],[p,[c,O+" Mini"]],[/\bopr\/([\w\.]+)/i// Opera Webkit
],[p,[c,O]],[// Mixed
...
],[p,[c,O+" Touch"]],[/coc_coc\w+\/([\w\.]+)/i// Coc Coc Browser
],[p,[c,"Coc Coc"]],[/dolfin\/([\w\.]+)/i// Dolphin
],[p,[c,"Dolphin"]],[/coast\/([\w\.]+)/i// Opera Coast
],[p,[c,O+" Coast"]],[/miuibrowser\/([\w\.]+)/i// MIUI Browser
...
/\b(milestone|droid(?:[2-4x]| (?:bionic|x2|pro|razr))?:?( 4g)?)\b[\w ]+build\//i,/\bmot(?:orola)?[- ](\w*)/i,/((?:moto[\w\(\) ]+|xt\d{3,4}|nexus 6)(?= bui|\)))/i],[u,[f,j],[d,g]],[/\b(mz60\d|xoom[2 ]{0,2}) build\//i],[u,[f,j],[d,v]],[// LG
...
/droid.+ (a?\d[0-2]{2}so|[c-g]\d{4}|so[-gl]\w+|xq-a\w[4-7][12])(?= bui|\).+chrome\/(?![1-6]{0,1}\d\.))/i],[u,[f,z],[d,g]],[/sony tablet [ps]/i,/\b(?:sony)?sgp\w+(?: bui|\))/i],[[u,"Xperia Tablet"],[f,z],[d,v]],[// OnePlus
...
],[u,[f,z],[d,y]],[/(mitv-\w{5}) bui/i// Xiaomi
...
],[u,[f,z],[d,m]],[/\b(xbox(?: one)?(?!; xbox))[\); ]/i// Microsoft Xbox
],[u,[f,N],[d,m]],[///////////////////
// WEARABLES
///////////////////
/((pebble))app/i// Pebble
...
console.error(e)}}(),u8=(v=m("foRq4")).createRoot,v.hydrateRoot,m("bh6RR"),m("bh6RR"),m("bh6RR");/**
 ...
 * Slot
 * -----------------------------------------------------------------------------------------------*/const P=/*#__PURE__*/(0,y.forwardRef)((e,t)=>{let{children:n,...r}=e,o=(0,y.Children).toArray(n),i=o.find(j);if(i){// the new element to render is the one passed as a child of `Slottable`
 ...
 * Slottable
 * -----------------------------------------------------------------------------------------------*/const N=({children:e})=>/*#__PURE__*/(0,y.createElement)(y.Fragment,null,e);/* ---------------------------------------------------------------------------------------------- */function j(e){return/*#__PURE__*/(0,y.isValidElement)(e)&&e.type===N}// We have resorted to returning slots directly rather than exposing primitives that can then
 ...
 */const A=(null==globalThis?void 0:globalThis.document)?y.useLayoutEffect:()=>{},D=y["useId".toString()]||(()=>void 0);let z=0;function I(e){let[t,n]=y.useState(D());// React versions older than 18 will have client-side ids only.
return A(()=>{e||n(e=>null!=e?e:String(z++))},[e]),e||(t?`radix-${t}`:"")}var y=m("bh6RR");// https://github.com/DefinitelyTyped/DefinitelyTyped/pull/55396
// prettier-ignore
/* -------------------------------------------------------------------------------------------------
 * Primitive
...
.filter(function(e){if(!e.isTailwindClass)return!0;var t=e.modifierId,n=e.classGroupId,r=e.hasPostfixModifier,o=t+n;return!s.has(o)&&(s.add(o),l(n,r).forEach(function(e){return s.add(t+e)}),!0)}).reverse().map(function(e){return e.originalClassName}).join(" "));return n(r,c),c}return function(){return a(ek.apply(null,arguments))}}(function(){var e=eS("colors"),t=eS("spacing"),n=eS("blur"),r=eS("brightness"),o=eS("borderColor"),i=eS("borderRadius"),a=eS("borderSpacing"),l=eS("borderWidth"),s=eS("contrast"),u=eS("grayscale"),c=eS("hueRotate"),d=eS("invert"),f=eS("gap"),p=eS("gradientColorStops"),h=eS("gradientColorStopPositions"),m=eS("inset"),g=eS("margin"),v=eS("opacity"),y=eS("padding"),b=eS("saturate"),w=eS("scale"),x=eS("sepia"),k=eS("skew"),S=eS("space"),E=eS("translate"),C=function(){return["auto","contain","none"]},_=function(){return["auto","hidden","clip","visible","scroll"]},R=function(){return["auto",eL,t]},P=function(){return[eL,t]},T=function(){return["",eN]},N=function(){return["auto",eI,eL]},j=function(){return["bottom","center","left","left-bottom","left-top","right","right-bottom","right-top","top"]},O=function(){return["solid","dashed","dotted","double","none"]},A=function(){return["normal","multiply","screen","overlay","darken","lighten","color-dodge","color-burn","hard-light","soft-light","difference","exclusion","hue","saturation","color","luminosity","plus-lighter"]},D=function(){return["start","end","center","between","around","evenly","stretch"]},z=function(){return["","0",eL]},I=function(){return["auto","avoid","all","avoid-page","page","left","right","column"]},M=function(){return[eI,ez]},F=function(){return[eI,eL]};return{cacheSize:500,theme:{colors:[e$],spacing:[eN],blur:["none","",eU,eL],brightness:M(),borderColor:[e],borderRadius:["none","","full",eU,eL],borderSpacing:P(),borderWidth:T(),contrast:M(),grayscale:z(),hueRotate:F(),invert:z(),gap:P(),gradientColorStops:[e],gradientColorStopPositions:[eM,ej],inset:R(),margin:R(),opacity:M(),padding:P(),saturate:M(),scale:M(),sepia:z(),skew:F(),space:P(),translate:P()},classGroups:{// Layout
/**
       * Aspect Ratio
       ...
       */"object-position":[{object:[].concat(j(),[eL])}],/**
       * Overflow
...
/**
       ...
       */"line-clamp":[{"line-clamp":["none",eI,ez]}],/**
       * Line Height
       ...
       */"text-decoration-style":[{decoration:[].concat(O(),["wavy"])}],/**
...
/**
       ...
       */"border-style":[{border:[].concat(O(),["hidden"])}],/**
       * Divide Width X
       ...
       */"outline-style":[{outline:[""].concat(O())}],/**
       * Outline Offset
...
console.warn(Error().stack)),new Date(NaN)))}function rM(e,t){rz(2,arguments);var n=rI(e),r=rA(t);return isNaN(r)?new Date(NaN):(r&&n.setDate(n.getDate()+r),n)}/**
 ...
 */function rF(e){var t=new Date(Date.UTC(e.getFullYear(),e.getMonth(),e.getDate(),e.getHours(),e.getMinutes(),e.getSeconds(),e.getMilliseconds()));return t.setUTCFullYear(e.getFullYear()),e.getTime()-t.getTime()}function rL(e){rz(1,arguments);var t=rI(e);return t.setHours(0,0,0,0),t}// for accurate equality comparisons of UTC timestamps that end up
...
t["%C2"]="�";let r=Object.keys(t);for(let n of r)e=e.replace(RegExp(n,"g"),t[n]);return e}(e)}}(e):e}function r8(e){let t=e.indexOf("#");return -1!==t&&(e=e.slice(0,t)),e}function r9(e,t){return t.parseNumbers&&!Number.isNaN(Number(e))&&"string"==typeof e&&""!==e.trim()?e=Number(e):t.parseBooleans&&null!==e&&("true"===e.toLowerCase()||"false"===e.toLowerCase())&&(e="true"===e.toLowerCase()),e}function r7(e){e=r8(e);let t=e.indexOf("?");return -1===t?"":e.slice(t+1)}function oe(e,t){r4((t={decode:!0,sort:!0,arrayFormat:"none",arrayFormatSeparator:",",parseNumbers:!1,parseBooleans:!1,...t}).arrayFormatSeparator);let n=function(e){let t;switch(e.arrayFormat){case"index":return(e,n,r)=>{if(t=/\[(\d*)]$/.exec(e),e=e.replace(/\[\d*]$/,""),!t){r[e]=n;return}void 0===r[e]&&(r[e]={}),r[e][t[1]]=n};case"bracket":return(e,n,r)=>{if(t=/(\[])$/.exec(e),e=e.replace(/\[]$/,""),!t){r[e]=n;return}if(void 0===r[e]){r[e]=[n];return}r[e]=[...r[e],n]};case"colon-list-separator":return(e,n,r)=>{if(t=/(:list)$/.exec(e),e=e.replace(/:list$/,""),!t){r[e]=n;return}if(void 0===r[e]){r[e]=[n];return}r[e]=[...r[e],n]};case"comma":case"separator":return(t,n,r)=>{let o="string"==typeof n&&n.includes(e.arrayFormatSeparator),i="string"==typeof n&&!o&&r5(n,e).includes(e.arrayFormatSeparator);n=i?r5(n,e):n;let a=o||i?n.split(e.arrayFormatSeparator).map(t=>r5(t,e)):null===n?n:r5(n,e);r[t]=a};case"bracket-separator":return(t,n,r)=>{let o=/(\[])$/.test(t);if(t=t.replace(/\[]$/,""),!o){r[t]=n?r5(n,e):n;return}let i=null===n?[]:n.split(e.arrayFormatSeparator).map(t=>r5(t,e));if(void 0===r[t]){r[t]=i;return}r[t]=[...r[t],...i]};default:return(e,t,n)=>{if(void 0===n[e]){n[e]=t;return}n[e]=[...[n[e]].flat(),t]}}}(t),r=Object.create(null);if("string"!=typeof e||!(e=e.trim().replace(/^[?#&]/,"")))return r;for(let o of e.split("&")){if(""===o)continue;let e=t.decode?o.replace(/\+/g," "):o,[i,a]=r0(e,"=");void 0===i&&(i=e),// Missing `=` should be `null`:
...
//   ],
// ];
const oa=[[{category:"States Where Dad Lived",words:["New York","Maryland","Massachusetts","Oklahoma"],difficulty:1},{category:"Employers of the members of the Yale board of trustees",words:["Morehouse","Comcast","Connecticut","Yale"],difficulty:2},{category:"Tennis Companions",words:["Cliffe","Guillermo","Mike","Nate"],difficulty:3},{category:"Handsome Men",words:["Dad","Dan","Squidward","Ben"],difficulty:4,imageSrc:"https://preview.redd.it/anybody-else-ironically-think-handsome-squidward-is-really-v0-1snloyd49aob1.jpg?width=1080&crop=smart&auto=webp&s=70fed1d710f73e19982746f5b6394ba440cc81ac"},{category:"Missed Connections",words:["Bruce","Annie","Kennya","Jenny"],difficulty:5},{category:"Al-____ Names",words:["Lie","Ex","F","Bert"],difficulty:6}]],ol=()=>rL(Date.now()),os=new Date(2023,9,23),ou=e=>{let t=rL(e),n=function(e,t){rz(2,arguments);var n=rI(e),r=rI(t),o=r$(n,r),i=Math.abs(function(e,t){rz(2,arguments);var n=rL(e),r=rL(t);// Round the number of days to the nearest integer
...
function(e){let t=e.length,n=1;return t>7?(n-=.1*(t-7),n=Math.max(.5,n),`${n}em`):null}(e)},className:"font-space-mono uppercase sm:text-xs md:text-xs",children:e})})},y=m("bh6RR"),oR=Object.defineProperty,oP={};((e,t)=>{for(var n in t)oR(e,n,{get:t[n],enumerable:!0})})(oP,{assign:()=>o5,colors:()=>o3,createStringInterpolator:()=>u7,skipAnimation:()=>o4,to:()=>ce,willAdvance:()=>o6});// ../rafz/dist/react-spring_rafz.modern.mjs
var oT=oH(),oN=e=>oU(e,oT),oj=oH();oN.write=e=>oU(e,oj);var oO=oH();oN.onStart=e=>oU(e,oO);var oA=oH();oN.onFrame=e=>oU(e,oA);var oD=oH();oN.onFinish=e=>oU(e,oD);var oz=[];oN.setTimeout=(e,t)=>{let n=oN.now()+t,r=()=>{let e=oz.findIndex(e=>e.cancel==r);~e&&oz.splice(e,1),oL-=~e?1:0},o={time:n,handler:e,cancel:r};return oz.splice(oI(n),0,o),oL+=1,oV(),o};var oI=e=>~(~oz.findIndex(t=>t.time>e)||~oz.length);oN.cancel=e=>{oO.delete(e),oA.delete(e),oD.delete(e),oT.delete(e),oj.delete(e)},oN.sync=e=>{o$=!0,oN.batchedUpdates(e),o$=!1},oN.throttle=e=>{let t;function n(){try{e(...t)}finally{t=null}}function r(...e){t=e,oN.onStart(n)}return r.handler=e,r.cancel=()=>{oO.delete(n),t=null},r};var oM="undefined"!=typeof window?window.requestAnimationFrame:()=>{};oN.use=e=>oM=e,oN.now="undefined"!=typeof performance?()=>performance.now():Date.now,oN.batchedUpdates=e=>e(),oN.catch=console.error,oN.frameLoop="always",oN.advance=()=>{"demand"!==oN.frameLoop?console.warn("Cannot call the manual advancement of rafz whilst frameLoop is not set as demand"):oB()};var oF=-1,oL=0,o$=!1;function oU(e,t){o$?(t.delete(e),e(0)):(t.add(e),oV())}function oV(){oF<0&&(oF=0,"demand"!==oN.frameLoop&&oM(oW))}function oW(){~oF&&(oM(oW),oN.batchedUpdates(oB))}function oB(){let e=oF;oF=oN.now();let t=oI(oF);if(t&&(oq(oz.splice(0,t),e=>e.handler()),oL-=t),!oL){oF=-1;return}oO.flush(),oT.flush(e?Math.min(64,oF-e):16.667),oA.flush(),oj.flush(),oD.flush()}function oH(){let e=/* @__PURE__ */new Set,t=e;return{add(n){oL+=t!=e||e.has(n)?0:1,e.add(n)},delete:n=>(oL-=t==e&&e.has(n)?1:0,e.delete(n)),flush(n){t.size&&(e=/* @__PURE__ */new Set,oL-=t.size,oq(t,t=>t(n)&&e.add(t)),oL+=e.size,t=e)}}}function oq(e,t){e.forEach(e=>{try{t(e)}catch(e){oN.catch(e)}})}// src/helpers.ts
function oG(){}var oQ=(e,t,n)=>Object.defineProperty(e,t,{value:n,writable:!0,configurable:!0}),oK={arr:Array.isArray,obj:e=>!!e&&"Object"===e.constructor.name,fun:e=>"function"==typeof e,str:e=>"string"==typeof e,num:e=>"number"==typeof e,und:e=>void 0===e};function oY(e,t){if(oK.arr(e)){if(!oK.arr(t)||e.length!==t.length)return!1;for(let n=0;n<e.length;n++)if(e[n]!==t[n])return!1;return!0}return e===t}var oX=(e,t)=>e.forEach(t);function oZ(e,t,n){if(oK.arr(e)){for(let r=0;r<e.length;r++)t.call(n,e[r],`${r}`);return}for(let r in e)e.hasOwnProperty(r)&&t.call(n,e[r],r)}var oJ=e=>oK.und(e)?[]:oK.arr(e)?e:[e];function o0(e,t){if(e.size){let n=Array.from(e);e.clear(),oX(n,t)}}var o1=(e,...t)=>o0(e,e=>e(...t)),o2=()=>"undefined"==typeof window||!window.navigator||/ServerSideRendering|^Deno\//.test(window.navigator.userAgent),o3=null,o4=!1,o6=oG,o5=e=>{e.to&&(ce=e.to),e.now&&(oN.now=e.now),void 0!==e.colors&&(o3=e.colors),null!=e.skipAnimation&&(o4=e.skipAnimation),e.createStringInterpolator&&(u7=e.createStringInterpolator),e.requestAnimationFrame&&oN.use(e.requestAnimationFrame),e.batchedUpdates&&(oN.batchedUpdates=e.batchedUpdates),e.willAdvance&&(o6=e.willAdvance),e.frameLoop&&(oN.frameLoop=e.frameLoop)},o8=/* @__PURE__ */new Set,o9=[],o7=[],ie=0,it={get idle(){return!o8.size&&!o9.length},/** Advance the given animation on every frame until idle. */start(e){ie>e.priority?(o8.add(e),oN.onStart(ir)):(io(e),oN(ia))},advance:/** Advance all animations by the given time. */ia,/** Call this when an animation's priority changes. */sort(e){if(ie)oN.onFrame(()=>it.sort(e));else{let t=o9.indexOf(e);~t&&(o9.splice(t,1),ii(e))}},/**
...
var aC=[],a_=class{constructor(){this.changed=!1,this.values=aC,this.toValues=null,this.fromValues=aC,this.config=new aS,this.immediate=!1}};function aR(e,{key:t,props:n,defaultProps:r,state:o,actions:i}){return new Promise((a,l)=>{let s,u;let c=af(n.cancel??r?.cancel,t);if(c)p();else{oK.und(n.pause)||(o.paused=af(n.pause,t));let e=r?.pause;!0!==e&&(e=o.paused||af(e,t)),s=ad(n.delay||0,t),e?(o.resumeQueue.add(f),i.pause()):(i.resume(),f())}function d(){o.resumeQueue.add(f),o.timeouts.delete(u),u.cancel(),s=u.time-oN.now()}function f(){s>0&&!oP.skipAnimation?(o.delayed=!0,u=oN.setTimeout(p,s),o.pauseQueue.add(d),o.timeouts.add(u)):p()}function p(){o.delayed&&(o.delayed=!1),o.pauseQueue.delete(d),o.timeouts.delete(u),e<=(o.cancelId||0)&&(c=!0);try{i.start({...n,callId:e,cancel:c},a)}catch(e){l(e)}}})}// src/AnimationResult.ts
var aP=(e,t)=>1==t.length?t[0]:t.some(e=>e.cancelled)?aj(e.get()):t.every(e=>e.noop)?aT(e.get()):aN(e.get(),t.every(e=>e.finished)),aT=e=>({value:e,noop:!0,finished:!0,cancelled:!1}),aN=(e,t,n=!1)=>({value:e,finished:t,cancelled:n}),aj=e=>({value:e,cancelled:!0,finished:!1});// src/runAsync.ts
function aO(e,t,n,r){let{callId:o,parentId:i,onRest:a}=t,{asyncTo:l,promise:s}=n;return i||e!==l||t.reset?n.promise=(async()=>{let u,c,d;n.asyncId=o,n.asyncTo=e;let f=ag(t,(e,t)=>"onRest"===t?void 0:e),p=new Promise((e,t)=>(u=e,c=t)),h=e=>{let t=o<=(n.cancelId||0)&&aj(r)||// The async `to` prop was replaced.
o!==n.asyncId&&aN(r,!1);if(t)throw e.result=t,c(e),e},m=(e,t)=>{let i=new aD,a=new az;return(async()=>{if(oP.skipAnimation)throw aA(n),a.result=aN(r,!1),c(a),a;h(i);let l=oK.obj(e)?{...e}:{...t,to:e};l.parentId=o,oZ(f,(e,t)=>{oK.und(l[t])&&(l[t]=e)});let s=await r.start(l);return h(i),n.paused&&await new Promise(e=>{n.resumeQueue.add(e)}),s})()};if(oP.skipAnimation)return aA(n),aN(r,!1);try{let t;t=oK.arr(e)?(async e=>{for(let t of e)await m(t)})(e):Promise.resolve(e(m,r.stop.bind(r))),await Promise.all([t.then(u),p]),d=aN(r.get(),!0,!1)}catch(e){if(e instanceof aD)d=e.result;else if(e instanceof az)d=e.result;else throw e}finally{o==n.asyncId&&(n.asyncId=i,n.asyncTo=i?l:void 0,n.promise=i?s:void 0)}return oK.fun(a)&&oN.batchedUpdates(()=>{a(d,r,r.item)}),d})():s}function aA(e,t){o0(e.timeouts,e=>e.cancel()),e.pauseQueue.clear(),e.resumeQueue.clear(),e.asyncId=e.asyncTo=e.promise=void 0,t&&(e.cancelId=t)}var aD=class extends Error{constructor(){super("An async animation has been interrupted. You see this error because you forgot to use `await` or `.catch(...)` on its returned promise.")}},az=class extends Error{constructor(){super("SkipAnimationSignal")}},aI=e=>e instanceof aF,aM=1,aF=class extends iA{constructor(){super(...arguments),this.id=aM++,this._priority=0}get priority(){return this._priority}set priority(e){this._priority!=e&&(this._priority=e,this._onPriorityChange(e))}/** Get the current value */get(){let e=i5(this);return e&&e.getValue()}/** Create a spring that maps our value to another value */to(...e){return oP.to(this,e)}/** @deprecated Use the `to` method instead. */interpolate(...e){return iK(`${iG}The "interpolate" function is deprecated in v9 (use "to" instead)`),oP.to(this,e)}toJSON(){return this.get()}observerAdded(e){1==e&&this._attach()}observerRemoved(e){0==e&&this._detach()}/** Called when the first child is added. */_attach(){}/** Called when the last child is removed. */_detach(){}/** Tell our children about our new value */_onChange(e,t=!1){iO(this,{type:"change",parent:this,value:e,idle:t})}/** Tell our children about our new priority */_onPriorityChange(e){this.idle||it.sort(this),iO(this,{type:"priority",parent:this,priority:e})}},aL=Symbol.for("SpringPhase"),a$=e=>(1&e[aL])>0,aU=e=>(2&e[aL])>0,aV=e=>(4&e[aL])>0,aW=(e,t)=>t?e[aL]|=3:e[aL]&=-3,aB=(e,t)=>t?e[aL]|=4:e[aL]&=-5,aH=class extends aF{constructor(e,t){if(super(),/** The animation state */this.animation=new a_,/** Some props have customizable default values */this.defaultProps={},/** The state for `runAsync` calls */this._state={paused:!1,delayed:!1,pauseQueue:/* @__PURE__ */new Set,resumeQueue:/* @__PURE__ */new Set,timeouts:/* @__PURE__ */new Set},/** The promise resolvers of pending `start` calls */this._pendingCalls=/* @__PURE__ */new Set,/** The counter for tracking `scheduleProps` calls */this._lastCallId=0,/** The last `scheduleProps` call that changed the `to` prop */this._lastToId=0,this._memoizedDuration=0,!oK.und(e)||!oK.und(t)){let n=oK.obj(e)?{...e}:{...t,from:e};oK.und(n.default)&&(n.default=!0),this.start(n)}}/** Equals true when not advancing on each frame. */get idle(){return!(aU(this)||this._state.asyncTo)||aV(this)}get goal(){return iN(this.animation.to)}get velocity(){let e=i5(this);return e instanceof ae?e.lastVelocity||0:e.getPayload().map(e=>e.lastVelocity||0)}/**
   ...
   */_prepareNode(e){let t=this.key||"",{to:n,from:r}=e;(null==(n=oK.obj(n)?n[t]:n)||ax(n))&&(n=void 0),null==(r=oK.obj(r)?r[t]:r)&&(r=void 0);let o={to:n,from:r};return a$(this)||(e.reverse&&([n,r]=[r,n]),r=iN(r),oK.und(r)?i5(this)||this._set(n):this._set(r)),o}/** Every update is processed by this method before merging. */_update({...e},t){let{key:n,defaultProps:r}=this;e.default&&Object.assign(r,ag(e,(e,t)=>/^on/.test(t)?ap(e,n):e)),aX(this,e,"onProps"),aZ(this,"onProps",e,this);let o=this._prepareNode(e);if(Object.isFrozen(this))throw Error("Cannot animate a `SpringValue` object that is frozen. Did you forget to pass your component to `animated(...)` before animating its props?");let i=this._state;return aR(++this._lastCallId,{key:n,props:e,defaultProps:r,state:i,actions:{pause:()=>{aV(this)||(aB(this,!0),o1(i.pauseQueue),aZ(this,"onPause",aN(this,aq(this,this.animation.to)),this))},resume:()=>{aV(this)&&(aB(this,!1),aU(this)&&this._resume(),o1(i.resumeQueue),aZ(this,"onResume",aN(this,aq(this,this.animation.to)),this))},start:this._merge.bind(this,o)}}).then(n=>{if(e.loop&&n.finished&&!(t&&n.noop)){let t=aG(e);if(t)return this._update(t,!0)}return n})}/** Merge props into the current animation */_merge(e,t,n){if(t.cancel)return this.stop(!0),n(aj(this));let r=!oK.und(e.to),o=!oK.und(e.from);if(r||o){if(!(t.callId>this._lastToId))return n(aj(this));this._lastToId=t.callId}let{key:i,defaultProps:a,animation:l}=this,{to:s,from:u}=l,{to:c=s,from:d=u}=e;o&&!r&&(!t.default||oK.und(c))&&(c=d),t.reverse&&([c,d]=[d,c]);let f=!oY(d,u);f&&(l.from=d),d=iN(d);let p=!oY(c,s);p&&this._focus(c);let h=ax(t.to),{config:m}=l,{decay:g,velocity:v}=m;(r||o)&&(m.velocity=0),t.config&&!h&&function(e,t,n){for(let r in n&&(aE(n={...n},t),t={...n,...t}),aE(e,t),Object.assign(e,t),ak)null==e[r]&&(e[r]=ak[r]);let{frequency:r,damping:o}=e,{mass:i}=e;oK.und(r)||(r<.01&&(r=.01),o<0&&(o=0),e.tension=Math.pow(2*Math.PI/r,2)*i,e.friction=4*Math.PI*o*i/r)}(m,ad(t.config,i),t.config!==a.config?ad(a.config,i):void 0);let y=i5(this);if(!y||oK.und(c))return n(aN(this,!0));let b=oK.und(t.reset)?o&&!t.default:!oK.und(d)&&af(t.reset,i),w=b?d:this.get(),x=aw(c),k=oK.num(x)||oK.arr(x)||iX(x),S=!h&&(!k||af(a.immediate||t.immediate,i));if(p){let e=aa(c);if(e!==y.constructor){if(S)y=this._set(x);else throw Error(`Cannot animate between ${y.constructor.name} and ${e.name}, as the "to" prop suggests`)}}let E=y.constructor,C=iT(c),_=!1;if(!C){let e=b||!a$(this)&&f;(p||e)&&(C=!(_=oY(aw(w),x))),(oY(l.immediate,S)||S)&&oY(m.decay,g)&&oY(m.velocity,v)||(C=!0)}if(_&&aU(this)&&(l.changed&&!b?C=!0:C||this._stop(s)),!h&&((C||iT(s))&&(l.values=y.getPayload(),l.toValues=iT(c)?null:E==at?[1]:oJ(x)),l.immediate==S||(l.immediate=S,S||b||this._set(s)),C)){let{onRest:e}=l;oX(aY,e=>aX(this,t,e));let r=aN(this,aq(this,s));o1(this._pendingCalls,r),this._pendingCalls.add(n),l.changed&&oN.batchedUpdates(()=>{l.changed=!b,e?.(r,this),b?ad(a.onRest,r):l.onStart?.(r,this)})}b&&this._set(w),h?n(aO(t.to,t,this._state,this)):C?this._start():aU(this)&&!p?this._pendingCalls.add(n):n(aT(w))}/** Update the `animation.to` value, which might be a `FluidValue` */_focus(e){let t=this.animation;e!==t.to&&(ij(this)&&this._detach(),t.to=e,ij(this)&&this._attach())}_attach(){let e=0,{to:t}=this.animation;iT(t)&&(iz(t,this),aI(t)&&(e=t.priority+1)),this.priority=e}_detach(){let{to:e}=this.animation;iT(e)&&iI(e,this)}/**
   * Update the current value from outside the frameloop,
   * and return the `Animated` node.
   */_set(e,t=!0){let n=iN(e);if(!oK.und(n)){let e=i5(this);if(!e||!oY(n,e.getValue())){let r=aa(n);e&&e.constructor==r?e.setValue(n):i8(this,r.create(n)),e&&oN.batchedUpdates(()=>{this._onChange(n,t)})}}return i5(this)}_onStart(){let e=this.animation;e.changed||(e.changed=!0,aZ(this,"onStart",aN(this,aq(this,e.to)),this))}_onChange(e,t){t||(this._onStart(),ad(this.animation.onChange,e,this)),ad(this.defaultProps.onChange,e,this),super._onChange(e,t)}// This method resets the animation state (even if already animating) to
// ensure the latest from/to range is used, and it also ensures this spring
// is added to the frameloop.
_start(){let e=this.animation;i5(this).reset(iN(e.to)),e.immediate||(e.fromValues=e.values.map(e=>e.lastPosition)),aU(this)||(aW(this,!0),aV(this)||this._resume())}_resume(){oP.skipAnimation?this.finish():it.start(this)}/**
   * Exit the frameloop and notify `onRest` listeners.
   *
   * Always wrap `_stop` calls with `batchedUpdates`.
   */_stop(e,t){if(aU(this)){aW(this,!1);let n=this.animation;oX(n.values,e=>{e.done=!0}),n.toValues&&(n.onChange=n.onPause=n.onResume=void 0),iO(this,{type:"idle",parent:this});let r=t?aj(this.get()):aN(this.get(),aq(this,e??n.to));o1(this._pendingCalls,r),n.changed&&(n.changed=!1,aZ(this,"onRest",r,this))}}};function aq(e,t){let n=aw(t),r=aw(e.get());return oY(r,n)}function aG(e,t=e.loop,n=e.to){let r=ad(t);if(r){let o=!0!==r&&ab(r),i=(o||e).reverse,a=!o||o.reset;return aQ({...e,loop:t,// Avoid updating default props when looping.
...
getComponentProps:({scrollTop:e,scrollLeft:t,...n})=>n}).animated,y=(m("bh6RR"),m("bh6RR"),m("bh6RR"));const lb=["top","right","bottom","left"],lw=Math.min,lx=Math.max,lk=Math.round,lS=Math.floor,lE=e=>({x:e,y:e}),lC={left:"right",right:"left",bottom:"top",top:"bottom"},l_={start:"end",end:"start"};function lR(e,t){return"function"==typeof e?e(t):e}function lP(e){return e.split("-")[0]}function lT(e){return e.split("-")[1]}function lN(e){return"x"===e?"y":"x"}function lj(e){return"y"===e?"height":"width"}function lO(e){return["top","bottom"].includes(lP(e))?"y":"x"}function lA(e){return e.replace(/start|end/g,e=>l_[e])}function lD(e){return e.replace(/left|right|bottom|top/g,e=>lC[e])}function lz(e){return"number"!=typeof e?{top:0,right:0,bottom:0,left:0,...e}:{top:e,right:e,bottom:e,left:e}}function lI(e){return{...e,top:e.y,left:e.x,right:e.x+e.width,bottom:e.y+e.height}}function lM(e,t,n){let r,{reference:o,floating:i}=e,a=lO(t),l=lN(lO(t)),s=lj(l),u=lP(t),c="y"===a,d=o.x+o.width/2-i.width/2,f=o.y+o.height/2-i.height/2,p=o[s]/2-i[s]/2;switch(u){case"top":r={x:d,y:o.y-i.height};break;case"bottom":r={x:d,y:o.y+o.height};break;case"right":r={x:o.x+o.width,y:f};break;case"left":r={x:o.x-i.width,y:f};break;default:r={x:o.x,y:o.y}}switch(lT(t)){case"start":r[l]-=p*(n&&c?-1:1);break;case"end":r[l]+=p*(n&&c?-1:1)}return r}/**
 ...
 */const l$=e=>({name:"arrow",options:e,async fn(t){let{x:n,y:r,placement:o,rects:i,platform:a,elements:l,middlewareData:s}=t,{element:u,padding:c=0}=lR(e,t)||{};if(null==u)return{};let d=lz(c),f={x:n,y:r},p=lN(lO(o)),h=lj(p),m=await a.getDimensions(u),g="y"===p,v=g?"clientHeight":"clientWidth",y=i.reference[h]+i.reference[p]-f[p]-i.floating[h],b=f[p]-i.reference[p],w=await (null==a.getOffsetParent?void 0:a.getOffsetParent(u)),x=w?w[v]:0;// DOM platform can return `window` as the `offsetParent`.
    ...
    let k=x/2-m[h]/2-1,S=lw(d[g?"top":"left"],k),E=lw(d[g?"bottom":"right"],k),C=x-m[h]-E,_=x/2-m[h]/2+(y/2-b/2),R=lx(S,lw(_,C)),P=!s.arrow&&null!=lT(o)&&_!=R&&i.reference[h]/2-(_<S?S:E)-m[h]/2<0,T=P?_<S?_-S:_-C:0;return{[p]:f[p]+T,data:{[p]:R,centerOffset:_-R-T,...P&&{alignmentOffset:T}},reset:P}}});function lU(e,t){return{top:e.top-t.height,right:e.right-t.width,bottom:e.bottom-t.height,left:e.left-t.width}}function lV(e){return lb.some(t=>e[t]>=0)}// For type backwards-compatibility, the `OffsetOptions` type was also
// Derivable.
async function lW(e,t){let{placement:n,platform:r,elements:o}=e,i=await (null==r.isRTL?void 0:r.isRTL(o.floating)),a=lP(n),l=lT(n),s="y"===lO(n),u=["left","top"].includes(a)?-1:1,c=i&&s?-1:1,d=lR(t,e),{mainAxis:f,crossAxis:p,alignmentAxis:h}="number"==typeof d?{mainAxis:d,crossAxis:0,alignmentAxis:null}:{mainAxis:0,crossAxis:0,alignmentAxis:null,...d};return l&&"number"==typeof h&&(p="end"===l?-1*h:h),s?{x:p*c,y:f*u}:{x:f*u,y:p*c}}function lB(e){return lG(e)?(e.nodeName||"").toLowerCase():"#document"}function lH(e){var t;return(null==e?void 0:null==(t=e.ownerDocument)?void 0:t.defaultView)||window}function lq(e){var t;return null==(t=(lG(e)?e.ownerDocument:e.document)||window.document)?void 0:t.documentElement}function lG(e){return e instanceof Node||e instanceof lH(e).Node}function lQ(e){return e instanceof Element||e instanceof lH(e).Element}function lK(e){return e instanceof HTMLElement||e instanceof lH(e).HTMLElement}function lY(e){return(// Browsers without `ShadowRoot` support.
...
lq(e);return lY(t)?t.host:t}function l4(e,t,n){var r;void 0===t&&(t=[]),void 0===n&&(n=!0);let o=function e(t){let n=l3(t);return l0(n)?t.ownerDocument?t.ownerDocument.body:t.body:lK(n)&&lX(n)?n:e(n)}(e),i=o===(null==(r=e.ownerDocument)?void 0:r.body),a=lH(o);return i?t.concat(a,a.visualViewport||[],lX(o)?o:[],a.frameElement&&n?l4(a.frameElement):[]):t.concat(o,l4(o,[],n))}function l6(e){let t=l1(e),n=parseFloat(t.width)||0,r=parseFloat(t.height)||0,o=lK(e),i=o?e.offsetWidth:n,a=o?e.offsetHeight:r,l=lk(n)!==i||lk(r)!==a;return l&&(n=i,r=a),{width:n,height:r,$:l}}function l5(e){return lQ(e)?e:e.contextElement}function l8(e){let t=l5(e);if(!lK(t))return lE(1);let n=t.getBoundingClientRect(),{width:r,height:o,$:i}=l6(t),a=(i?lk(n.width):n.width)/r,l=(i?lk(n.height):n.height)/o;return a&&Number.isFinite(a)||(a=1),l&&Number.isFinite(l)||(l=1),{x:a,y:l}}const l9=lE(0);function l7(e){let t=lH(e);return lJ()&&t.visualViewport?{x:t.visualViewport.offsetLeft,y:t.visualViewport.offsetTop}:l9}function se(e,t,n,r){var o;void 0===t&&(t=!1),void 0===n&&(n=!1);let i=e.getBoundingClientRect(),a=l5(e),l=lE(1);t&&(r?lQ(r)&&(l=l8(r)):l=l8(e));let s=(void 0===(o=n)&&(o=!1),r&&(!o||r===lH(a))&&o)?l7(a):lE(0),u=(i.left+s.x)/l.x,c=(i.top+s.y)/l.y,d=i.width/l.x,f=i.height/l.y;if(a){let e=lH(a),t=r&&lQ(r)?lH(r):r,n=e.frameElement;for(;n&&r&&t!==e;){let e=l8(n),t=n.getBoundingClientRect(),r=l1(n),o=t.left+(n.clientLeft+parseFloat(r.paddingLeft))*e.x,i=t.top+(n.clientTop+parseFloat(r.paddingTop))*e.y;u*=e.x,c*=e.y,d*=e.x,f*=e.y,u+=o,c+=i,n=lH(n).frameElement}}return lI({width:d,height:f,x:u,y:c})}function st(e){// If <html> has a CSS width greater than the viewport, then this will be
// incorrect for RTL.
return se(lq(e)).left+l2(e).scrollLeft}function sn(e,t,n){let r;if("viewport"===t)r=function(e,t){let n=lH(e),r=lq(e),o=n.visualViewport,i=r.clientWidth,a=r.clientHeight,l=0,s=0;if(o){i=o.width,a=o.height;let e=lJ();(!e||e&&"fixed"===t)&&(l=o.offsetLeft,s=o.offsetTop)}return{width:i,height:a,x:l,y:s}}(e,n);else if("document"===t)r=// Gets the entire size of the scrollable document area, even extending outside
// of the `<html>` and `<body>` rect bounds if horizontally scrollable.
function(e){let t=lq(e),n=l2(e),r=e.ownerDocument.body,o=lx(t.scrollWidth,t.clientWidth,r.scrollWidth,r.clientWidth),i=lx(t.scrollHeight,t.clientHeight,r.scrollHeight,r.clientHeight),a=-n.scrollLeft+st(e),l=-n.scrollTop;return"rtl"===l1(r).direction&&(a+=lx(t.clientWidth,r.clientWidth)-o),{width:o,height:i,x:a,y:l}}(lq(e));else if(lQ(t))r=// Returns the inner client rect, subtracting scrollbars if present.
function(e,t){let n=se(e,!0,"fixed"===t),r=n.top+e.clientTop,o=n.left+e.clientLeft,i=lK(e)?l8(e):lE(1),a=e.clientWidth*i.x,l=e.clientHeight*i.y,s=o*i.x,u=r*i.y;return{width:a,height:l,x:s,y:u}}(t,n);else{let n=l7(e);r={...t,x:t.x-n.x,y:t.y-n.y}}return lI(r)}function sr(e,t){return lK(e)&&"fixed"!==l1(e).position?t?t(e):e.offsetParent:null}// Gets the closest ancestor positioned element. Handles some edge cases,
// such as table ancestors and cross browser bugs.
function so(e,t){let n=lH(e);if(!lK(e))return n;let r=sr(e,t);for(;r&&["table","td","th"].includes(lB(r))&&"static"===l1(r).position;)r=sr(r,t);return r&&("html"===lB(r)||"body"===lB(r)&&"static"===l1(r).position&&!lZ(r))?n:r||function(e){let t=l3(e);for(;lK(t)&&!l0(t);){if(lZ(t))return t;t=l3(t)}return null}(e)||n}const si=async function(e){let{reference:t,floating:n,strategy:r}=e,o=this.getOffsetParent||so,i=this.getDimensions;return{reference:function(e,t,n){let r=lK(t),o=lq(t),i="fixed"===n,a=se(e,!0,i,t),l={scrollLeft:0,scrollTop:0},s=lE(0);if(r||!r&&!i){if(("body"!==lB(t)||lX(o))&&(l=l2(t)),r){let e=se(t,!0,i,t);s.x=e.x+t.clientLeft,s.y=e.y+t.clientTop}else o&&(s.x=st(o))}return{x:a.left+l.scrollLeft-s.x,y:a.top+l.scrollTop-s.y,width:a.width,height:a.height}}(t,await o(n),r),floating:{x:0,y:0,...await i(n)}}},sa={convertOffsetParentRelativeRectToViewportRelativeRect:function(e){let{rect:t,offsetParent:n,strategy:r}=e,o=lK(n),i=lq(n);if(n===i)return t;let a={scrollLeft:0,scrollTop:0},l=lE(1),s=lE(0);if((o||!o&&"fixed"!==r)&&(("body"!==lB(n)||lX(i))&&(a=l2(n)),lK(n))){let e=se(n);l=l8(n),s.x=e.x+n.clientLeft,s.y=e.y+n.clientTop}return{width:t.width*l.x,height:t.height*l.y,x:t.x*l.x-a.scrollLeft*l.x+s.x,y:t.y*l.y-a.scrollTop*l.y+s.y}},getDocumentElement:lq,getClippingRect:// Gets the maximum area that the element is visible in due to any number of
// clipping ancestors.
...
r=e.offsetWidth,o=e.offsetHeight;n({width:r,height:o})});return t.observe(e,{box:"border-box"}),()=>t.unobserve(e)}n(void 0)},[e]),t}(U),B=null!==(n=null==W?void 0:W.width)&&void 0!==n?n:0,H=null!==(r=null==W?void 0:W.height)&&void 0!==r?r:0,q="number"==typeof P?P:{top:0,right:0,bottom:0,left:0,...P},G=Array.isArray(_)?_:[_],Q=G.length>0,K={padding:q,boundary:G.filter(s_),// with `strategy: 'fixed'`, this is the only way to get it to respect boundaries
altBoundary:Q},{refs:Y,floatingStyles:X,placement:Z,isPositioned:J,middlewareData:ee}=/**
 * Provides data to position a floating element.
 * @see https://floating-ui.com/docs/react
 */function(e){void 0===e&&(e={});let{placement:t="bottom",strategy:n="absolute",middleware:r=[],platform:o,elements:{reference:i,floating:a}={},transform:l=!0,whileElementsMounted:s,open:u}=e,[c,d]=y.useState({x:0,y:0,strategy:n,placement:t,middlewareData:{},isPositioned:!1}),[f,p]=y.useState(r);sc(f,r)||p(r);let[h,m]=y.useState(null),[g,b]=y.useState(null),w=y.useCallback(e=>{e!=E.current&&(E.current=e,m(e))},[m]),x=y.useCallback(e=>{e!==C.current&&(C.current=e,b(e))},[b]),k=i||h,S=a||g,E=y.useRef(null),C=y.useRef(null),_=y.useRef(c),R=sp(s),P=sp(o),T=y.useCallback(()=>{if(!E.current||!C.current)return;let e={placement:t,strategy:n,middleware:f};P.current&&(e.platform=P.current),sl(E.current,C.current,e).then(e=>{let t={...e,isPositioned:!0};N.current&&!sc(_.current,t)&&(_.current=t,v.flushSync(()=>{d(t)}))})},[f,t,n,P]);su(()=>{!1===u&&_.current.isPositioned&&(_.current.isPositioned=!1,d(e=>({...e,isPositioned:!1})))},[u]);let N=y.useRef(!1);su(()=>(N.current=!0,()=>{N.current=!1}),[]),su(()=>{if(k&&(E.current=k),S&&(C.current=S),k&&S){if(R.current)return R.current(k,S,T);T()}},[k,S,T,R]);let j=y.useMemo(()=>({reference:E,floating:C,setReference:w,setFloating:x}),[w,x]),O=y.useMemo(()=>({reference:k,floating:S}),[k,S]),A=y.useMemo(()=>{let e={position:n,left:0,top:0};if(!O.floating)return e;let t=sf(O.floating,c.x),r=sf(O.floating,c.y);return l?{...e,transform:"translate("+t+"px, "+r+"px)",...sd(O.floating)>=1.5&&{willChange:"transform"}}:{position:n,left:t,top:r}},[n,l,O.floating,c.x,c.y]);return y.useMemo(()=>({...c,update:T,refs:j,elements:O,floatingStyles:A}),[c,T,j,O,A])}({// default to `fixed` strategy so users don't have to pick and we also avoid focus scroll issues
 ...
 */function(e,t,n,r){let o;void 0===r&&(r={});let{ancestorScroll:i=!0,ancestorResize:a=!0,elementResize:l="function"==typeof ResizeObserver,layoutShift:s="function"==typeof IntersectionObserver,animationFrame:u=!1}=r,c=l5(e),d=i||a?[...c?l4(c):[],...l4(t)]:[];d.forEach(e=>{i&&e.addEventListener("scroll",n,{passive:!0}),a&&e.addEventListener("resize",n)});let f=c&&s?// https://samthor.au/2021/observing-dom/
function(e,t){let n,r=null,o=lq(e);function i(){clearTimeout(n),r&&r.disconnect(),r=null}return!function a(l,s){void 0===l&&(l=!1),void 0===s&&(s=1),i();let{left:u,top:c,width:d,height:f}=e.getBoundingClientRect();if(l||t(),!d||!f)return;let p=lS(c),h=lS(o.clientWidth-(u+d)),m=lS(o.clientHeight-(c+f)),g=lS(u),v={rootMargin:-p+"px "+-h+"px "+-m+"px "+-g+"px",threshold:lx(0,lw(1,s))||1},y=!0;function b(e){let t=e[0].intersectionRatio;if(t!==s){if(!y)return a();t?a(!1,t):n=setTimeout(()=>{a(!1,1e-7)},100)}y=!1}// Older browsers don't support a `document` as the root and will throw an
// error.
...
if(!n)switch(g){case"bestFit":{let e=null==(i=R.map(e=>[e.placement,e.overflows.filter(e=>e>0).reduce((e,t)=>e+t,0)]).sort((e,t)=>e[1]-t[1])[0])?void 0:i[0];e&&(n=e);break}case"initialPlacement":n=u}if(a!==n)return{reset:{placement:n}}}return{}}},{name:"size",options:h={...K,apply:({elements:e,rects:t,availableWidth:n,availableHeight:r})=>{let{width:o,height:i}=t.reference,a=e.floating.style;a.setProperty("--radix-popper-available-width",`${n}px`),a.setProperty("--radix-popper-available-height",`${r}px`),a.setProperty("--radix-popper-anchor-width",`${o}px`),a.setProperty("--radix-popper-anchor-height",`${i}px`)}},async fn(e){let t,n;let{placement:r,rects:o,platform:i,elements:a}=e,{apply:l=()=>{},...s}=lR(h,e),u=await lL(e,s),c=lP(r),d=lT(r),f="y"===lO(r),{width:p,height:m}=o.floating;"top"===c||"bottom"===c?(t=c,n=d===(await (null==i.isRTL?void 0:i.isRTL(a.floating))?"start":"end")?"left":"right"):(n=c,t="end"===d?"top":"bottom");let g=m-u[t],v=p-u[n],y=!e.middlewareData.shift,b=g,w=v;if(f){let e=p-u.left-u.right;w=d||y?lw(v,e):e}else{let e=m-u.top-u.bottom;b=d||y?lw(g,e):e}if(y&&!d){let e=lx(u.left,0),t=lx(u.right,0),n=lx(u.top,0),r=lx(u.bottom,0);f?w=p-2*(0!==e||0!==t?e+t:lx(u.left,u.right)):b=m-2*(0!==n||0!==r?n+r:lx(u.top,u.bottom))}await l({...e,availableWidth:w,availableHeight:b});let x=await i.getDimensions(a.floating);return p!==x.width||m!==x.height?{reset:{rects:!0}}:{}}},U&&ss({element:U,padding:E}),sR({arrowWidth:B,arrowHeight:H}),N&&{name:"hide",options:m={strategy:"referenceHidden",...K},async fn(e){let{rects:t}=e,{strategy:n="referenceHidden",...r}=lR(m,e);switch(n){case"referenceHidden":{let n=await lL(e,{...r,elementContext:"reference"}),o=lU(n,t.reference);return{data:{referenceHiddenOffsets:o,referenceHidden:lV(o)}}}case"escaped":{let n=await lL(e,{...r,altBoundary:!0}),o=lU(n,t.floating);return{data:{escapedOffsets:o,escaped:lV(o)}}}default:return{}}}}]}),[et,en]=sP(Z),er=L(O);A(()=>{J&&(null==er||er())},[J,er]);let eo=null===(o=ee.arrow)||void 0===o?void 0:o.x,ei=null===(i=ee.arrow)||void 0===i?void 0:i.y,ea=(null===(a=ee.arrow)||void 0===a?void 0:a.centerOffset)!==0,[el,es]=(0,y.useState)();return A(()=>{I&&es(window.getComputedStyle(I).zIndex)},[I]),/*#__PURE__*/(0,y.createElement)("div",{ref:Y.setFloating,"data-radix-popper-content-wrapper":"",style:{...X,transform:J?X.transform:"translate(0, -200%)",// keep off the page when measuring
...
return cn.call(this,e,0)}}}!function(){try{cn="function"==typeof setTimeout?setTimeout:uD}catch(e){cn=uD}try{cr="function"==typeof clearTimeout?clearTimeout:uz}catch(e){cr=uz}}();var uM=[],uF=!1,uL=-1;function u$(){uF&&co&&(uF=!1,co.length?uM=co.concat(uM):uL=-1,uM.length&&uU())}function uU(){if(!uF){var e=uI(u$);uF=!0;for(var t=uM.length;t;){for(co=uM,uM=[];++uL<t;)co&&co[uL].run();uL=-1,t=uM.length}co=null,uF=!1,function(e){if(cr===clearTimeout)return clearTimeout(e);// if clearTimeout wasn't available but was latter defined
if((cr===uz||!cr)&&clearTimeout)return cr=clearTimeout,clearTimeout(e);try{// when when somebody has screwed with setTimeout but no I.E. maddness
 ...
 */function(e){return e?e.slice(0,fR(e)+1).replace(fT,""):e};var fN={},fj={};fj=/**
 ...
 * _.isSymbol('abc');
 * // => false
 */function(e){return"symbol"==typeof e||fj(e)&&"[object Symbol]"==fu(e)};/** Used as references for various `Number` constants. */var fO=0/0,fA=/^[-+]0x[0-9a-f]+$/i,fD=/^0b[01]+$/i,fz=/^0o[0-7]+$/i,fI=parseInt;fC=/**
 ...
 * _.toNumber('3.2');
 * // => 3.2
 */function(e){if("number"==typeof e)return e;if(fN(e))return fO;if(fw(e)){var t="function"==typeof e.valueOf?e.valueOf():e;e=fw(t)?t+"":t}if("string"!=typeof e)return 0===e?e:+e;e=f_(e);var n=fD.test(e);return n||fz.test(e)?fI(e.slice(2),n?2:8):fA.test(e)?fO:+e};/** Used as references for various `Number` constants. */var fM=1/0;function fF(e,t){if(null==e)return{};var n,r,o={},i=Object.keys(e);for(r=0;r<i.length;r++)n=i[r],t.indexOf(n)>=0||(o[n]=e[n]);return o}fE=/**
...
this.index.slice(0).forEach(e.onProcessRule,e)}/**
   ...
   */,t.updateOne=function(t,n,r){void 0===r&&(r=pO);var o=this.options,i=o.jss.plugins,a=o.sheet;// It is a rules container like for e.g. ConditionalRule.
...
if(!1===(r=pK(n,e.toString({children:!1}),o)))return!1;this.refCssRule(e,o,r)}return this.insertRules(e.rules,r),r}var i=e.toString();if(!i)return!1;var a=pY(n,t),l=pK(n,i,a);return!1!==l&&(this.hasInsertedRules=!0,this.refCssRule(e,a,l),l)},t.refCssRule=function(e,t,n){e.renderable=n,e.options.parent instanceof pz&&this.cssRules.splice(t,0,n)}/**
   * Delete a rule.
   ...
   */,t.getRules=function(){return this.element.sheet.cssRules},e}(),pJ=0,p0=/*#__PURE__*/function(){function e(e){this.id=pJ++,this.version="10.10.0",this.plugins=new pI,this.options={id:{minify:!1},createGenerateId:pU,Renderer:f6?pZ:null,plugins:[]},this.generateId=pU({minify:!1});for(var t=0;t<pj.length;t++)this.plugins.use(pj[t],{queue:"internal"});this.setup(e)}/**
   ...
   */,t.createStyleSheet=function(e,t){void 0===t&&(t={});var n=t.index;"number"!=typeof n&&(n=0===pM.index?0:pM.index+1);var r=new pz(e,S({},t,{jss:this,generateId:t.generateId||this.generateId,insertionPoint:this.options.insertionPoint,Renderer:this.options.Renderer,index:n}));return this.plugins.onProcessSheet(r),r}/**
...
if(void 0!==e[o]&&(r||!t.prop(i))){var a,l=hj(((a={})[i]=e[o],a),t)[i];// Add style directly in rule
 ...
 */function hj(e,t,n){for(var r in e){var o=e[r];if(Array.isArray(o)){if(!Array.isArray(o[0])){if("fallbacks"===r){for(var i=0;i<e.fallbacks.length;i++)e.fallbacks[i]=hj(e.fallbacks[i],t,!0);continue}e[r]=/**
 * Convert array to nested array, if needed
 */function e(t,n,r,o){return null==r[n]?t:0===t.length?[]:Array.isArray(t[0])?e(t[0],n,r,o):"object"==typeof t[0]?t.map(function(e){return hN(e,n,o,!1,!0)}):[t]}(o,r,h_,t),e[r].length||delete e[r]}}else if("object"==typeof o){if("fallbacks"===r){e.fallbacks=hj(e.fallbacks,t,!0);continue}e[r]=hN(o,r,t,n),e[r].length||delete e[r]}else""===e[r]&&delete e[r]}return e}function hO(e,t){(null==t||t>e.length)&&(t=e.length);for(var n=0,r=Array(t);n<t;n++)r[n]=e[n];return r}// Export javascript style and css style vendor prefixes.
var hA="",hD="",hz="",hI="",hM=f6&&"ontouchstart"in document.documentElement;if(f6){// Order matters. We need to check Webkit the last one because
// other vendors use to add Webkit prefixes to some properties
var hF={Moz:"-moz-",ms:"-ms-",O:"-o-",Webkit:"-webkit-"},hL=document.createElement("p").style;for(var h$ in hF)if(h$+"Transform" in hL){hA=h$,hD=hF[h$];break}"Webkit"===hA&&"msHyphens"in hL&&(hA="ms",hD=hF.ms,hI="edge"),"Webkit"===hA&&"-apple-trailing-word"in hL&&(hz="apple")}/**
 * Vendor prefix string for the current browser.
 *
 * @type {{js: String, css: String, vendor: String, browser: String}}
 * @api public
 */var hU={js:hA,css:hD,vendor:hz,browser:hI,isTouch:hM},hV=/[-\s]+(.)?/g;/**
...
try{u.style[e]=""}catch(e){return!1}return hJ[e]}var h3={},h4={transition:1,"transition-property":1,"-webkit-transition":1,"-webkit-transition-property":1},h6=/(^\s*[\w-]+)|, (\s*[\w-]+)(?![^()]*\))/g;/**
 ...
 * @return {String}
 * @api private
 */function h5(e,t,n){return"var"===t?"var":"all"===t?"all":"all"===n?", all":(t?h2(t):", "+h2(n))||t||n}/**
...
if(h4[e])n=n.replace(h6,h5);else if(""===c.style[e]&&("-ms-flex"===// Value with a vendor prefix.
(n=hU.css+n)&&(c.style[e]="-ms-flexbox"),c.style[e]=n,""===c.style[e]))return h3[r]=!1,!1;// Reset styles for current property.
return c.style[e]="",h3[r]=n,h3[r]}f6&&(c=document.createElement("p"));var h9=/**
 * Sort props by length.
 */function(){var e=function(e,t){return e.length===t.length?e>t?1:-1:e.length-t.length};return{onProcessStyle:function(t,n){if("style"!==n.type)return t;for(var r={},o=Object.keys(t).sort(e),i=0;i<o.length;i++)r[o[i]]=t[o[i]];return r}}},h7=function(e){var t;return void 0===e&&(e={}),{plugins:[{onCreateRule:function(e,t,n){if("function"!=typeof t)return null;var r=pr(e,{},n);return r[p5]=t,r},onProcessStyle:function(e,t){// We need to extract function values from the declaration, so that we can keep core unaware of them.
// We need to do that only once.
// We don't need to extract functions on each style update, since this can happen only once.
// We don't support function values inside of function rules.
if(p6 in t||p5 in t)return e;var n={};for(var r in e){var o=e[r];"function"==typeof o&&(delete e[r],n[r]=o)}return t[p6]=n,e},onUpdate:function(e,t,n,r){var o=t[p5];// If we have a style function, the entire rule is dynamic and style object
// will be returned from that function.
o&&// Empty object will remove all currently defined props
// in case function rule returns a falsy value.
(t.style=o(e)||{});var i=t[p6];// If we have a fn values map, it is a rule with function values.
...
for(var n=0;n<e.length;n++)e[n]=hj(e[n],t);return e}return hj(e,t)}},{onProcessRule:function(e){if("keyframes"===e.type){var t;e.at=// Keyframes is already prefixed. e.g. key = '@-webkit-keyframes a'
...
return i.getSheet=o,i}(),mn=Number.MIN_SAFE_INTEGER||-1e9,mr=(0,y.createContext)({classNamePrefix:"",disableStylesGeneration:!1,isSSR:!f6}),mo=new Map,mi=function(e,t){// If `managers` map is present in the context, we use it in order to
 ...
 * _.toString([1, 2, 3]);
 * // => '1,2,3'
 */function(e){return null==e?"":mE(e)};/* Built-in method references for those with the same name as other `lodash` methods. */var mN=fd.isFinite,mj=Math.min;o=Math.round,mx=function(e,t){if(e=fC(e),(t=null==t?0:mj(mk(t),292))&&mN(e)){// Shift with exponential notation to avoid floating-point issues.
// See [MDN](https://mdn.io/round#Examples) for more details.
var n=(mS(e)+"e").split("e"),r=o(n[0]+"e"+(+n[1]+t));return+((n=(mS(r)+"e").split("e"))[0]+"e"+(+n[1]-t))}return o(e)};var mO={},mA={},mD={},mz={},mI={},mM={};mM=/**
...
mB.prototype.clear=mM,mB.prototype.delete=mF,mB.prototype.get=mU,mB.prototype.has=mV,mB.prototype.set=mW,mI=mB;var mH={};mH=/**
 * Removes all key-value entries from the stack.
 *
 * @private
 * @name clear
 * @memberOf Stack
 */function(){this.__data__=new mI,this.size=0};var mq={};mq=/**
 ...
 */function(e){if(null!=e){try{return m3.call(e)}catch(e){}try{return e+""}catch(e){}}return""};/** Used to detect host constructors (Safari). */var m4=/^\[object .+?Constructor\]$/,m6=Object.prototype,m5=Function.prototype.toString,m8=m6.hasOwnProperty,m9=RegExp("^"+m5.call(m8).replace(/[\\^$.*+?()[\]{}|]/g,"\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g,"$1.*?")+"$");mZ=/**
 ...
 * @name clear
 * @memberOf MapCache
 */function(){this.size=0,this.__data__={hash:new gn,map:new(mY||mI),string:new gn}};var gf={},gp={},gh={};gh=/**
 ...
 */function(e,t){var n=this.__data__;if(n instanceof mI){var r=n.__data__;if(!mY||r.length<199)return r.push([e,t]),this.size=++n.size,this;n=this.__data__=new ge(r)}return n.set(e,t),this.size=n.size,this},// Add methods to `Stack`.
gb.prototype.clear=mH,gb.prototype.delete=mq,gb.prototype.get=mG,gb.prototype.has=mQ,gb.prototype.set=mK,mz=gb;var gw={},gx={},gk={};gk=/**
 ...
 */function(e){var t=-1,n=Array(e.size);return e.forEach(function(e){n[++t]=e}),n};/** Used to convert symbols to primitives and strings. */var gj=fc?fc.prototype:void 0,gO=gj?gj.valueOf:void 0;gR=/**
...
a.set(e,t);var c=gw(l(e),l(t),r,o,i,a);return a.delete(e),c;case"[object Symbol]":if(gO)return gO.call(e)==gO.call(t)}return!1};var gA={},gD={},gz={},gI={};gI=/**
 ...
 */function(e,t){for(var n=-1,r=t.length,o=e.length;++n<r;)e[o+n]=t[n];return e},gz=/**
 ...
 */function(e,t,n){var r=t(e);return m_(e)?r:gI(r,n(e))};var gM={},gF={};gF=/**
 ...
 */function(e){return fj(e)&&"[object Arguments]"==fu(e)};/** Used for built-in method references. */var gG=Object.prototype,gQ=gG.hasOwnProperty,gK=gG.propertyIsEnumerable;gH=gq(function(){return arguments}())?gq:function(e){return fj(e)&&gQ.call(e,"callee")&&!gK.call(e,"callee")};var gY=m("8TKuU"),gX={},gZ={},gJ={};gJ["[object Float32Array]"]=gJ["[object Float64Array]"]=gJ["[object Int8Array]"]=gJ["[object Int16Array]"]=gJ["[object Int32Array]"]=gJ["[object Uint8Array]"]=gJ["[object Uint8ClampedArray]"]=gJ["[object Uint16Array]"]=gJ["[object Uint32Array]"]=!0,gJ["[object Arguments]"]=gJ["[object Array]"]=gJ["[object ArrayBuffer]"]=gJ["[object Boolean]"]=gJ["[object DataView]"]=gJ["[object Date]"]=gJ["[object Error]"]=gJ["[object Function]"]=gJ["[object Map]"]=gJ["[object Number]"]=gJ["[object Object]"]=gJ["[object RegExp]"]=gJ["[object Set]"]=gJ["[object String]"]=gJ["[object WeakMap]"]=!1,gZ=/**
 * The base implementation of `_.isTypedArray` without Node.js optimizations.
 *
 * @private
 * @param {*} value The value to check.
 * @returns {boolean} Returns `true` if `value` is a typed array, else `false`.
 */function(e){return fj(e)&&fx(e.length)&&!!gJ[fu(e)]};var g0={};g0=/**
...
fk(u,s)))&&l.push(u);return l};var g4={},g6={},g5=Object.prototype;g6=/**
 * Checks if `value` is likely a prototype object.
 *
 * @private
 * @param {*} value The value to check.
 * @returns {boolean} Returns `true` if `value` is a prototype, else `false`.
 */function(e){var t=e&&e.constructor;return e===("function"==typeof t&&t.prototype||g5)};var g8={};i=Object.keys,a=Object,g8=function(e){return i(a(e))};/** Used to check objects for own properties. */var g9=Object.prototype.hasOwnProperty;g4=/**
 * The base implementation of `_.keys` which doesn't treat sparse arrays as dense.
 *
 * @private
 * @param {Object} object The object to query.
 * @returns {Array} Returns the array of property names.
 */function(e){if(!g6(e))return g8(e);var t=[];for(var n in Object(e))g9.call(e,n)&&"constructor"!=n&&t.push(n);return t},gV=/**
 ...
 * @param {Object} object The object to query.
 * @returns {Array} Returns the array of property names and symbols.
 */function(e){return gz(e,gV,gM)};/** Used to check objects for own properties. */var g7=Object.prototype.hasOwnProperty;gA=/**
 ...
 * @param {Object} [stack] Tracks traversed `object` and `other` objects.
 * @returns {boolean} Returns `true` if the objects are equivalent, else `false`.
 */function(e,t,n,r,o,i){var a=m_(e),l=m_(t),s=a?vv:ve(e),u=l?vv:ve(t);s=s==vg?vy:s,u=u==vg?vy:u;var c=s==vy,d=u==vy,f=s==u;if(f&&gY(e)){if(!gY(t))return!1;a=!0,c=!1}if(f&&!c)return i||(i=new mz),a||gX(e)?gw(e,t,n,r,o,i):gR(e,t,s,n,r,o,i);if(!(1&n)){var p=c&&vb.call(e,"__wrapped__"),h=d&&vb.call(t,"__wrapped__");if(p||h){var m=p?e.value():e,g=h?t.value():t;return i||(i=new mz),o(m,g,n,r,i)}}return!!f&&(i||(i=new mz),gA(e,t,n,r,o,i))},mA=/**
 ...
 * @returns {boolean} Returns `true` if the values are equivalent, else `false`.
 */function e(t,n,r,o,i){return t===n||(null!=t&&null!=n&&(fj(t)||fj(n))?mD(t,n,r,o,e,i):t!=t&&n!=n)},mO=/**
